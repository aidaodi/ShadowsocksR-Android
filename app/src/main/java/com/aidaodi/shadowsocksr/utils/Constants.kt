package com.aidaodi.shadowsocksr.utils
...
object Constants
{
	...
	object Action
	{
		const val SERVICE = "com.aidaodi.shadowsocksr.SERVICE"
		const val CLOSE = "com.aidaodi.shadowsocksr.CLOSE"
		const val QUICK_SWITCH = "com.aidaodi.shadowsocksr.QUICK_SWITCH"
		const val SCAN = "com.aidaodi.shadowsocksr.intent.action.SCAN"
		const val SORT = "com.aidaodi.shadowsocksr.intent.action.SORT"
		const val MANUAL_ADD = "com.aidaodi.shadowsocksr.intent.action.MANUAL_ADD"
		const val SUB_ADD = "com.aidaodi.shadowsocksr.intent.action.SUB_ADD"
		const val IMPORT_ADD = "com.aidaodi.shadowsocksr.intent.action.IMPORT_ADD"
		const val NFC_ADD = "com.aidaodi.shadowsocksr.intent.action.NFC_ADD"
	}
